...
int main(int argc, char *argv[]) {
  ...
  10:	e8 0d 03 00 00       	call   322 <lotto>
  15:	85 c0                	test   %eax,%eax
  17:	74 33                	je     4c <main+0x4c>
#include "types.h"
#include "stat.h"
#include "user.h"
int main(int argc, char *argv[]) {
  19:	ba f8 a7 00 00       	mov    $0xa7f8,%edx
  1e:	66 90                	xchg   %ax,%ax
		sleep(5);
	}
	...
	for(i=0;i<loop;i++)
        {
                asm("nop");
  20:	90                   	nop
  21:	b8 f8 a7 00 00       	mov    $0xa7f8,%eax
  26:	66 90                	xchg   %ax,%ax
                for(k=0;k<loop;k++)
                {
                        asm("nop");
  ...
  31:	75 ed                	jne    20 <main+0x20>
	...
	printf(1,"Program 3 ended");
  33:	c7 44 24 04 36 07 00 	movl   $0x736,0x4(%esp)
  3a:	00 
  3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  42:	e8 89 03 00 00       	call   3d0 <printf>
        exit();
  47:	e8 36 02 00 00       	call   282 <exit>
#include "user.h"
int main(int argc, char *argv[]) {
        int i,k;
        if(lotto(250)==0)
	{
		sleep(5);
  4c:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  53:	e8 ba 02 00 00       	call   312 <sleep>
  58:	eb bf                	jmp    19 <main+0x19>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 369:	0f b6 92 4d 07 00 00 	movzbl 0x74d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ff:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 501:	b8 46 07 00 00       	mov    $0x746,%eax
