...
8010028e:	e8 ed 3f 00 00       	call   80104280 <acquire>
  while(n > 0){
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 db 76 10 80 	movl   $0x801076db,(%esp)
...
8010060e:	e8 6d 3c 00 00       	call   80104280 <acquire>
...
80100797:	e8 e4 3a 00 00       	call   80104280 <acquire>
...
801007c5:	e8 b6 3a 00 00       	call   80104280 <acquire>
...
80100d83:	e8 f8 34 00 00       	call   80104280 <acquire>
...
80100df1:	e8 8a 34 00 00       	call   80104280 <acquire>
  if(f->ref < 1)
...
80100e43:	e8 38 34 00 00       	call   80104280 <acquire>
  if(f->ref < 1)
...
801011a5:	c7 04 24 ff 6d 10 80 	movl   $0x80106dff,(%esp)
...
80101239:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
8010123c:	e8 3f 30 00 00       	call   80104280 <acquire>
...
801012cc:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012cd:	c7 04 24 15 6e 10 80 	movl   $0x80106e15,(%esp)
...
80101385:	eb 93                	jmp    8010131a <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101387:	c7 04 24 25 6e 10 80 	movl   $0x80106e25,(%esp)
...
80101468:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101469:	c7 04 24 38 6e 10 80 	movl   $0x80106e38,(%esp)
...
801016a1:	e8 da 2b 00 00       	call   80104280 <acquire>
  ip->ref++;
...
80101814:	e8 67 2a 00 00       	call   80104280 <acquire>
  ip->ref--;
...
80101cb8:	e8 c3 25 00 00       	call   80104280 <acquire>
  ip->ref++;
...
80101efc:	e8 5f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101f01:	c7 04 24 c2 74 10 80 	movl   $0x801074c2,(%esp)
...
801020a0:	e8 db 21 00 00       	call   80104280 <acquire>
...
801020cc:	e8 af 1d 00 00       	call   80103e80 <wakeup>
...
80102176:	e8 05 21 00 00       	call   80104280 <acquire>
...
801021bb:	e8 20 1b 00 00       	call   80103ce0 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102387:	e8 f4 1e 00 00       	call   80104280 <acquire>
...
80102b2d:	e8 4e 17 00 00       	call   80104280 <acquire>
...
80102b47:	e8 94 11 00 00       	call   80103ce0 <sleep>
void
begin_op(void)
{
  acquire(&log.lock);
...
80102ba0:	e8 db 16 00 00       	call   80104280 <acquire>
  log.outstanding -= 1;
...
80102cfd:	e8 7e 15 00 00       	call   80104280 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103281:	e8 fa 0f 00 00       	call   80104280 <acquire>
  if(writable){
...
8010329d:	e8 de 0b 00 00       	call   80103e80 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032db:	e8 a0 0b 00 00       	call   80103e80 <wakeup>
...
8010330f:	e8 6c 0f 00 00       	call   80104280 <acquire>
  for(i = 0; i < n; i++){
...
8010335f:	e8 1c 0b 00 00       	call   80103e80 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103364:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103368:	89 34 24             	mov    %esi,(%esp)
8010336b:	e8 70 09 00 00       	call   80103ce0 <sleep>
{
  int i;
...
801033da:	e8 a1 0a 00 00       	call   80103e80 <wakeup>
  release(&p->lock);
...
80103402:	e8 79 0e 00 00       	call   80104280 <acquire>
...
8010342f:	e8 ac 08 00 00       	call   80103ce0 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801034b5:	e8 c6 09 00 00       	call   80103e80 <wakeup>
  release(&p->lock);
...
801034e3:	e8 98 0d 00 00       	call   80104280 <acquire>
...
801034fc:	0f 84 9e 00 00 00    	je     801035a0 <allocproc+0xd0>
    if(p->state == UNUSED)
...
80103515:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
  p->tickets = 1;
8010351c:	c7 43 7c 01 00 00 00 	movl   $0x1,0x7c(%ebx)
  release(&ptable.lock);
  return 0;
...
8010352c:	89 43 10             	mov    %eax,0x10(%ebx)
  p->tickets = 1;
  p->stride = 0;
8010352f:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
80103536:	00 00 00 
  p->pass = 0;
80103539:	c7 83 80 00 00 00 00 	movl   $0x0,0x80(%ebx)
80103540:	00 00 00 
  p->usageCount = 0;
80103543:	c7 83 88 00 00 00 00 	movl   $0x0,0x88(%ebx)
8010354a:	00 00 00 
  release(&ptable.lock);
8010354d:	e8 1e 0e 00 00       	call   80104370 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103552:	e8 59 ef ff ff       	call   801024b0 <kalloc>
80103557:	85 c0                	test   %eax,%eax
80103559:	89 43 08             	mov    %eax,0x8(%ebx)
8010355c:	74 56                	je     801035b4 <allocproc+0xe4>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010355e:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  ...
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
80103564:	05 9c 0f 00 00       	add    $0xf9c,%eax
    return 0;
  }
  sp = p->kstack + KSTACKSIZE;
  ...
  // Leave room for trap frame.
  sp -= sizeof *p->tf;
80103569:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
8010356c:	c7 40 14 20 55 10 80 	movl   $0x80105520,0x14(%eax)

  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
80103573:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
8010357a:	00 
8010357b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80103582:	00 
80103583:	89 04 24             	mov    %eax,(%esp)
  // which returns to trapret.
  sp -= 4;
  *(uint*)sp = (uint)trapret;
  ...
  sp -= sizeof *p->context;
  p->context = (struct context*)sp;
80103586:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103589:	e8 32 0e 00 00       	call   801043c0 <memset>
  p->context->eip = (uint)forkret;
8010358e:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103591:	c7 40 10 c0 35 10 80 	movl   $0x801035c0,0x10(%eax)

  return p;
80103598:	89 d8                	mov    %ebx,%eax
}
8010359a:	83 c4 14             	add    $0x14,%esp
8010359d:	5b                   	pop    %ebx
8010359e:	5d                   	pop    %ebp
8010359f:	c3                   	ret    
  ...
  release(&ptable.lock);
801035a0:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801035a7:	e8 c4 0d 00 00       	call   80104370 <release>
  p->context = (struct context*)sp;
  memset(p->context, 0, sizeof *p->context);
  p->context->eip = (uint)forkret;
...
801035b4:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
801035bb:	eb dd                	jmp    8010359a <allocproc+0xca>
...
801035cd:	e8 9e 0d 00 00       	call   80104370 <release>
...
80103616:	c7 44 24 04 95 72 10 	movl   $0x80107295,0x4(%esp)
8010361d:	80 
8010361e:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103625:	e8 66 0b 00 00       	call   80104190 <initlock>
}
8010362a:	c9                   	leave  
8010362b:	c3                   	ret    
...
80103688:	eb ea                	jmp    80103674 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010368a:	c7 04 24 9c 72 10 80 	movl   $0x8010729c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103696:	c7 04 24 90 73 10 80 	movl   $0x80107390,(%esp)
...
801036d4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801036d7:	e8 64 0b 00 00       	call   80104240 <pushcli>
  c = mycpu();
801036dc:	e8 4f ff ff ff       	call   80103630 <mycpu>
  p = c->proc;
801036e1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036e7:	e8 14 0c 00 00       	call   80104300 <popcli>
  return p;
}
...
80103713:	e8 78 33 00 00       	call   80106a90 <setupkvm>
...
80103735:	80 
80103736:	e8 85 30 00 00       	call   801067c0 <inituvm>
  p->sz = PGSIZE;
...
80103757:	e8 64 0c 00 00       	call   801043c0 <memset>
...
801037b2:	00 
801037b3:	c7 44 24 04 c5 72 10 	movl   $0x801072c5,0x4(%esp)
801037ba:	80 
801037bb:	89 04 24             	mov    %eax,(%esp)
801037be:	e8 dd 0d 00 00       	call   801045a0 <safestrcpy>
  p->cwd = namei("/");
801037c3:	c7 04 24 ce 72 10 80 	movl   $0x801072ce,(%esp)
801037ca:	e8 41 e7 ff ff       	call   80101f10 <namei>
...
801037d9:	e8 a2 0a 00 00       	call   80104280 <acquire>
...
801037ec:	e8 7f 0b 00 00       	call   80104370 <release>
}
...
801037f6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037f7:	c7 04 24 ac 72 10 80 	movl   $0x801072ac,(%esp)
...
80103839:	e8 c2 30 00 00       	call   80106900 <allocuvm>
...
80103847:	e8 64 2e 00 00       	call   801066b0 <switchuvm>
  return 0;
...
8010386a:	e8 81 31 00 00       	call   801069f0 <deallocuvm>
...
801038ae:	e8 bd 32 00 00       	call   80106b70 <copyuvm>
...
8010392d:	e8 6e 0c 00 00       	call   801045a0 <safestrcpy>
...
8010393c:	e8 3f 09 00 00       	call   80104280 <acquire>
...
8010394f:	e8 1c 0a 00 00       	call   80104370 <release>
...
801039b8:	e8 c3 08 00 00       	call   80104280 <acquire>
   struct proc *minProc;  
   int min = 10000;  
801039bd:	b9 10 27 00 00       	mov    $0x2710,%ecx
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039dc:	74 22                	je     80103a00 <scheduler+0x70>
      if(p->state != RUNNABLE)
801039de:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
801039e2:	75 ec                	jne    801039d0 <scheduler+0x40>
        continue;
      if(p->state == RUNNABLE && p->pass < min)
801039e4:	8b 82 80 00 00 00    	mov    0x80(%edx),%eax
801039ea:	39 c8                	cmp    %ecx,%eax
801039ec:	7d e2                	jge    801039d0 <scheduler+0x40>
801039ee:	89 d7                	mov    %edx,%edi
    sti();
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
   struct proc *minProc;  
   int min = 10000;  
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039f0:	81 c2 8c 00 00 00    	add    $0x8c,%edx
801039f6:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
801039fc:	89 c1                	mov    %eax,%ecx
801039fe:	75 de                	jne    801039de <scheduler+0x4e>
      		minProc = p;
		min = minProc->pass;
      }
    }
//	cprintf("Process selected is %s",minProc->name);
      if(min != 10000)
80103a00:	81 f9 10 27 00 00    	cmp    $0x2710,%ecx
80103a06:	74 78                	je     80103a80 <scheduler+0xf0>
      		// Switch to chosen process.  It is the process's job
      		// to release ptable.lock and then reacquire it
      		// before jumping back to us.
      	//	cprintf("Reached here");`i
      		p = minProc;
		p->stride = 10000/p->tickets;
80103a08:	b8 10 27 00 00       	mov    $0x2710,%eax
80103a0d:	99                   	cltd   
80103a0e:	f7 7f 7c             	idivl  0x7c(%edi)
80103a11:	89 87 84 00 00 00    	mov    %eax,0x84(%edi)
                p->pass += p->stride;
80103a17:	03 87 80 00 00 00    	add    0x80(%edi),%eax
		if(p->pass >= 10000)
80103a1d:	3d 0f 27 00 00       	cmp    $0x270f,%eax
      		// to release ptable.lock and then reacquire it
      		// before jumping back to us.
      	//	cprintf("Reached here");`i
      		p = minProc;
		p->stride = 10000/p->tickets;
                p->pass += p->stride;
80103a22:	89 87 80 00 00 00    	mov    %eax,0x80(%edi)
		if(p->pass >= 10000)
80103a28:	7e 1c                	jle    80103a46 <scheduler+0xb6>
80103a2a:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103a2f:	90                   	nop
			{
				//We have exceeded the max stride and should reset everyone to prevent integer overflow
				struct proc* aProc;
				for(aProc = ptable.proc; aProc < &ptable.proc[NPROC]; ++aProc)
				{
						aProc -> pass = 0;
80103a30:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80103a37:	00 00 00 
                p->pass += p->stride;
		if(p->pass >= 10000)
			{
				...
				struct proc* aProc;
				for(aProc = ptable.proc; aProc < &ptable.proc[NPROC]; ++aProc)
80103a3a:	05 8c 00 00 00       	add    $0x8c,%eax
80103a3f:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80103a44:	75 ea                	jne    80103a30 <scheduler+0xa0>
				{
						aProc -> pass = 0;
				}
		...
		p->usageCount += 1;
80103a46:	83 87 88 00 00 00 01 	addl   $0x1,0x88(%edi)
		c->proc = p;
80103a4d:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      		switchuvm(p);
80103a53:	89 3c 24             	mov    %edi,(%esp)
80103a56:	e8 55 2c 00 00       	call   801066b0 <switchuvm>
      		p->state = RUNNING;
		
      		swtch(&(c->scheduler), p->context);
80103a5b:	8b 47 1c             	mov    0x1c(%edi),%eax
		...
		c->proc = p;
      		switchuvm(p);
      		p->state = RUNNING;
80103a5e:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
		
      		swtch(&(c->scheduler), p->context);
80103a65:	89 34 24             	mov    %esi,(%esp)
80103a68:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a6c:	e8 8a 0b 00 00       	call   801045fb <swtch>
      		switchkvm();
80103a71:	e8 1a 2c 00 00       	call   80106690 <switchkvm>
      		// Process is done running for now.
      		// It should have changed its p->state before coming back.
      		c->proc = 0;
80103a76:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a7d:	00 00 00 
       }
       release(&ptable.lock);
80103a80:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a87:	e8 e4 08 00 00       	call   80104370 <release>
  }
80103a8c:	e9 1f ff ff ff       	jmp    801039b0 <scheduler+0x20>
80103a91:	eb 0d                	jmp    80103aa0 <sched>
80103a93:	90                   	nop
80103a94:	90                   	nop
80103a95:	90                   	nop
80103a96:	90                   	nop
...
80103aa8:	e8 23 fc ff ff       	call   801036d0 <myproc>

  if(!holding(&ptable.lock))
80103aad:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
// there's no process.
void
sched(void)
{
...
80103ab4:	89 c3                	mov    %eax,%ebx
  ...
  if(!holding(&ptable.lock))
80103ab6:	e8 55 07 00 00       	call   80104210 <holding>
80103abb:	85 c0                	test   %eax,%eax
80103abd:	74 4f                	je     80103b0e <sched+0x6e>
    panic("sched ptable.lock");
  if(mycpu()->ncli != 1)
80103abf:	e8 6c fb ff ff       	call   80103630 <mycpu>
...
80103ad8:	75 40                	jne    80103b1a <sched+0x7a>
  ...
  intena = mycpu()->intena;
80103ada:	e8 51 fb ff ff       	call   80103630 <mycpu>
...
80103ae2:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103ae8:	e8 43 fb ff ff       	call   80103630 <mycpu>
...
80103af7:	e8 ff 0a 00 00       	call   801045fb <swtch>
  mycpu()->intena = intena;
80103afc:	e8 2f fb ff ff       	call   80103630 <mycpu>
...
80103b0d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103b0e:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
80103b15:	e8 46 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103b1a:	c7 04 24 fc 72 10 80 	movl   $0x801072fc,(%esp)
80103b21:	e8 3a c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103b26:	c7 04 24 ee 72 10 80 	movl   $0x801072ee,(%esp)
80103b2d:	e8 2e c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103b32:	c7 04 24 e2 72 10 80 	movl   $0x801072e2,(%esp)
...
80103b47:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103b4a:	e8 81 fb ff ff       	call   801036d0 <myproc>
  struct proc *p;
  int fd;

  if(curproc == initproc)
80103b4f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
// An exited process remains in the zombie state
// until its parent calls wait() to find out it exited.
void
exit(void)
{
  struct proc *curproc = myproc();
80103b55:	89 c6                	mov    %eax,%esi
  struct proc *p;
  int fd;

  if(curproc == initproc)
80103b57:	0f 84 2d 01 00 00    	je     80103c8a <exit+0x14a>
80103b5d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd]){
80103b60:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
...
80103b6b:	e8 c0 d2 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103b70:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
80103b77:	00 
...
80103b7b:	83 fb 10             	cmp    $0x10,%ebx
80103b7e:	75 e0                	jne    80103b60 <exit+0x20>
  ...
  begin_op();
80103b80:	e8 9b ef ff ff       	call   80102b20 <begin_op>
  iput(curproc->cwd);
80103b85:	8b 46 68             	mov    0x68(%esi),%eax
80103b88:	89 04 24             	mov    %eax,(%esp)
80103b8b:	e8 50 dc ff ff       	call   801017e0 <iput>
  end_op();
80103b90:	e8 fb ef ff ff       	call   80102b90 <end_op>
  curproc->cwd = 0;
80103b95:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)

  acquire(&ptable.lock);
80103b9c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ba3:	e8 d8 06 00 00       	call   80104280 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(curproc->parent);
80103ba8:	8b 46 14             	mov    0x14(%esi),%eax
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bab:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103bd8:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80103bde:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
80103be4:	75 e0                	jne    80103bc6 <exit+0x86>
80103be6:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
80103beb:	eb 11                	jmp    80103bfe <exit+0xbe>
80103bed:	8d 76 00             	lea    0x0(%esi),%esi
80103bf0:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bf6:	81 fb c0 50 11 80    	cmp    $0x801150c0,%ebx
80103bfc:	74 36                	je     80103c34 <exit+0xf4>
    if(p->parent == curproc){
80103bfe:	39 73 a8             	cmp    %esi,-0x58(%ebx)
80103c01:	74 4d                	je     80103c50 <exit+0x110>
      p->parent = initproc;
      if(p->state == ZOMBIE)
        wakeup1(initproc);
    }
    if(p->name[4]=='1'||p->name[4]=='2'||p->name[4]=='3')
80103c03:	0f b6 43 04          	movzbl 0x4(%ebx),%eax
80103c07:	8d 50 cf             	lea    -0x31(%eax),%edx
80103c0a:	80 fa 02             	cmp    $0x2,%dl
80103c0d:	77 e1                	ja     80103bf0 <exit+0xb0>
    {
		cprintf("Process %s executed %d\t",p->name,p->usageCount);
80103c0f:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103c12:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103c16:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
80103c1c:	c7 04 24 1d 73 10 80 	movl   $0x8010731d,(%esp)
80103c23:	89 44 24 08          	mov    %eax,0x8(%esp)
80103c27:	e8 24 ca ff ff       	call   80100650 <cprintf>
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c2c:	81 fb c0 50 11 80    	cmp    $0x801150c0,%ebx
80103c32:	75 ca                	jne    80103bfe <exit+0xbe>
		cprintf("Process %s executed %d\t",p->name,p->usageCount);
    }
  }
...
80103c34:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
80103c3b:	e8 60 fe ff ff       	call   80103aa0 <sched>
  panic("zombie exit");
80103c40:	c7 04 24 35 73 10 80 	movl   $0x80107335,(%esp)
80103c47:	e8 14 c7 ff ff       	call   80100360 <panic>
80103c4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c50:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
      if(p->state == ZOMBIE)
80103c55:	83 7b a0 05          	cmpl   $0x5,-0x60(%ebx)
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c59:	89 43 a8             	mov    %eax,-0x58(%ebx)
      if(p->state == ZOMBIE)
80103c5c:	75 a5                	jne    80103c03 <exit+0xc3>
80103c5e:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c63:	eb 11                	jmp    80103c76 <exit+0x136>
...
wakeup1(void *chan)
{
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c68:	81 c2 8c 00 00 00    	add    $0x8c,%edx
80103c6e:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
80103c74:	74 8d                	je     80103c03 <exit+0xc3>
    if(p->state == SLEEPING && p->chan == chan)
80103c76:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103c7a:	75 ec                	jne    80103c68 <exit+0x128>
80103c7c:	3b 42 20             	cmp    0x20(%edx),%eax
80103c7f:	75 e7                	jne    80103c68 <exit+0x128>
      p->state = RUNNABLE;
80103c81:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80103c88:	eb de                	jmp    80103c68 <exit+0x128>
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
  ...
  if(curproc == initproc)
    panic("init exiting");
80103c8a:	c7 04 24 10 73 10 80 	movl   $0x80107310,(%esp)
...
80103d11:	e8 6a 05 00 00       	call   80104280 <acquire>
    release(lk);
80103d16:	89 34 24             	mov    %esi,(%esp)
80103d19:	e8 52 06 00 00       	call   80104370 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d21:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  ...
  sched();
80103d28:	e8 73 fd ff ff       	call   80103aa0 <sched>
...
80103d3b:	e8 30 06 00 00       	call   80104370 <release>
    acquire(lk);
...
80103d49:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103d4a:	e9 31 05 00 00       	jmp    80104280 <acquire>
80103d4f:	90                   	nop
  if(lk != &ptable.lock){  //DOC: sleeplock0
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
...
80103d53:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  ...
  sched();
80103d5a:	e8 41 fd ff ff       	call   80103aa0 <sched>
...
80103d6e:	c7 04 24 47 73 10 80 	movl   $0x80107347,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103d7a:	c7 04 24 41 73 10 80 	movl   $0x80107341,(%esp)
...
80103d95:	83 ec 10             	sub    $0x10,%esp
  ...
  int havekids, pid;
  struct proc *curproc = myproc();
80103d98:	e8 33 f9 ff ff       	call   801036d0 <myproc>
...
80103da4:	89 c6                	mov    %eax,%esi
  ...
  acquire(&ptable.lock);
80103da6:	e8 d5 04 00 00       	call   80104280 <acquire>
  for(;;){
...
80103e0e:	e8 ed e4 ff ff       	call   80102300 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
...
80103e20:	e8 eb 2b 00 00       	call   80106a10 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80103e25:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
...
80103e45:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e4c:	e8 1f 05 00 00       	call   80104370 <release>
    }
...
80103e61:	e8 0a 05 00 00       	call   80104370 <release>
    }
...
80103e91:	e8 ea 03 00 00       	call   80104280 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103edc:	e9 8f 04 00 00       	jmp    80104370 <release>
...
80103f01:	e8 7a 03 00 00       	call   80104280 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103f35:	e8 36 04 00 00       	call   80104370 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103f5f:	e8 0c 04 00 00       	call   80104370 <release>
  return -1;
}
...
80103f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f88:	c7 04 24 db 76 10 80 	movl   $0x801076db,(%esp)
...
80103fad:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103fb0:	ba 58 73 10 80       	mov    $0x80107358,%edx
  uint pc[10];
...
80103fb7:	8b 14 85 b8 73 10 80 	mov    -0x7fef8c48(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103fbe:	b8 58 73 10 80       	mov    $0x80107358,%eax
...
80103fd3:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
...
80103fff:	e8 ac 01 00 00       	call   801041b0 <getcallerpcs>
...
80104019:	c7 04 24 81 6d 10 80 	movl   $0x80106d81,(%esp)
...
8010404d:	e8 2e 02 00 00       	call   80104280 <acquire>
        for(i = 0; i < NPROC; i++)
        {
                p = myproc();
80104052:	e8 79 f6 ff ff       	call   801036d0 <myproc>
                if(p->state == UNUSED)
80104057:	8b 50 0c             	mov    0xc(%eax),%edx
8010405a:	85 d2                	test   %edx,%edx
8010405c:	74 1a                	je     80104078 <lotto+0x38>
                        return -1;
                p->tickets = tickets;
8010405e:	8b 55 08             	mov    0x8(%ebp),%edx
80104061:	89 50 7c             	mov    %edx,0x7c(%eax)
                release(&ptable.lock);
80104064:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010406b:	e8 00 03 00 00       	call   80104370 <release>
                return 0;
...
8010408a:	c7 44 24 04 d0 73 10 	movl   $0x801073d0,0x4(%esp)
80104091:	80 
...
801040d1:	e8 aa 01 00 00       	call   80104280 <acquire>
  while (lk->locked) {
...
801040e7:	e8 f4 fb ff ff       	call   80103ce0 <sleep>
...
801040f2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801040f8:	e8 d3 f5 ff ff       	call   801036d0 <myproc>
...
8010410b:	5d                   	pop    %ebp
  ...
  lk->pid = myproc()->pid;
  release(&lk->lk);
8010410c:	e9 5f 02 00 00       	jmp    80104370 <release>
...
80104131:	e8 4a 01 00 00       	call   80104280 <acquire>
  lk->locked = 0;
...
80104146:	e8 35 fd ff ff       	call   80103e80 <wakeup>
  release(&lk->lk);
...
80104153:	5d                   	pop    %ebp
{
  ...
  wakeup(lk);
  release(&lk->lk);
80104154:	e9 17 02 00 00       	jmp    80104370 <release>
...
80104171:	e8 0a 01 00 00       	call   80104280 <acquire>
  r = lk->locked;
80104176:	8b 1b                	mov    (%ebx),%ebx
  release(&lk->lk);
80104178:	89 34 24             	mov    %esi,(%esp)
8010417b:	e8 f0 01 00 00       	call   80104370 <release>
  return r;
}
...
80104219:	8b 55 08             	mov    0x8(%ebp),%edx
  return lock->locked && lock->cpu == mycpu();
8010421c:	8b 0a                	mov    (%edx),%ecx
8010421e:	85 c9                	test   %ecx,%ecx
80104220:	74 10                	je     80104232 <holding+0x22>
80104222:	8b 5a 08             	mov    0x8(%edx),%ebx
80104225:	e8 06 f4 ff ff       	call   80103630 <mycpu>
8010422a:	39 c3                	cmp    %eax,%ebx
8010422c:	0f 94 c0             	sete   %al
8010422f:	0f b6 c0             	movzbl %al,%eax
}
...
80104259:	e8 d2 f3 ff ff       	call   80103630 <mycpu>
8010425e:	81 e3 00 02 00 00    	and    $0x200,%ebx
80104264:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010426a:	e8 c1 f3 ff ff       	call   80103630 <mycpu>
...
80104287:	e8 b4 ff ff ff       	call   80104240 <pushcli>
  if(holding(lk))
...
{
  return lock->locked && lock->cpu == mycpu();
8010428f:	8b 02                	mov    (%edx),%eax
80104291:	85 c0                	test   %eax,%eax
80104293:	75 43                	jne    801042d8 <acquire+0x58>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
8010429a:	eb 07                	jmp    801042a3 <acquire+0x23>
...
801042aa:	75 f4                	jne    801042a0 <acquire+0x20>
  ...
  __sync_synchronize();
801042ac:	0f ae f0             	mfence 

  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
801042af:	8b 5d 08             	mov    0x8(%ebp),%ebx
801042b2:	e8 79 f3 ff ff       	call   80103630 <mycpu>
801042b7:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
801042ba:	8b 45 08             	mov    0x8(%ebp),%eax
801042bd:	83 c0 0c             	add    $0xc,%eax
801042c0:	89 44 24 04          	mov    %eax,0x4(%esp)
801042c4:	8d 45 08             	lea    0x8(%ebp),%eax
801042c7:	89 04 24             	mov    %eax,(%esp)
801042ca:	e8 e1 fe ff ff       	call   801041b0 <getcallerpcs>
}
...
{
  return lock->locked && lock->cpu == mycpu();
801042d8:	8b 5a 08             	mov    0x8(%edx),%ebx
801042db:	e8 50 f3 ff ff       	call   80103630 <mycpu>
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
801042e2:	74 05                	je     801042e9 <acquire+0x69>
801042e4:	8b 55 08             	mov    0x8(%ebp),%edx
801042e7:	eb ac                	jmp    80104295 <acquire+0x15>
    panic("acquire");
801042e9:	c7 04 24 db 73 10 80 	movl   $0x801073db,(%esp)
...
8010430b:	75 49                	jne    80104356 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010430d:	e8 1e f3 ff ff       	call   80103630 <mycpu>
...
80104325:	e8 06 f3 ff ff       	call   80103630 <mycpu>
...
80104336:	66 90                	xchg   %ax,%ax
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104338:	e8 f3 f2 ff ff       	call   80103630 <mycpu>
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
8010434a:	c7 04 24 fa 73 10 80 	movl   $0x801073fa,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104356:	c7 04 24 e3 73 10 80 	movl   $0x801073e3,(%esp)
...
8010437f:	75 0f                	jne    80104390 <release+0x20>
// Release the lock.
void
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104381:	c7 04 24 01 74 10 80 	movl   $0x80107401,(%esp)
80104388:	e8 d3 bf ff ff       	call   80100360 <panic>
...
{
  return lock->locked && lock->cpu == mycpu();
80104390:	8b 73 08             	mov    0x8(%ebx),%esi
80104393:	e8 98 f2 ff ff       	call   80103630 <mycpu>
...
8010439a:	75 e5                	jne    80104381 <release+0x11>
    panic("release");

  lk->pcs[0] = 0;
8010439c:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801043a3:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  // Tell the C compiler and the processor to not move loads or stores
  ...
  __sync_synchronize();
801043aa:	0f ae f0             	mfence 

  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  // not be atomic. A real OS would use C atomics here.
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801043ad:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
...
801043b8:	5d                   	pop    %ebp
  ...
  popcli();
801043b9:	e9 42 ff ff ff       	jmp    80104300 <popcli>
...
80104617:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010461a:	e8 b1 f0 ff ff       	call   801036d0 <myproc>
...
80104657:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010465a:	e8 71 f0 ff ff       	call   801036d0 <myproc>
...
801046bb:	e8 10 f0 ff ff       	call   801036d0 <myproc>
...
801046e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801046eb:	e8 e0 ef ff ff       	call   801036d0 <myproc>
...
8010479d:	8b 14 85 40 74 10 80 	mov    -0x7fef8bc0(,%eax,4),%edx
...
801047c6:	c7 04 24 09 74 10 80 	movl   $0x80107409,(%esp)
...
80104950:	c7 44 24 04 b8 74 10 	movl   $0x801074b8,0x4(%esp)
80104957:	80 
...
8010496b:	c7 44 24 04 b7 74 10 	movl   $0x801074b7,0x4(%esp)
80104972:	80 
...
80104981:	79 89                	jns    8010490c <create+0xdc>
      panic("create dots");
80104983:	c7 04 24 ab 74 10 80 	movl   $0x801074ab,(%esp)
8010498a:	e8 d1 b9 ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
8010498f:	c7 04 24 ba 74 10 80 	movl   $0x801074ba,(%esp)
80104996:	e8 c5 b9 ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010499b:	c7 04 24 9c 74 10 80 	movl   $0x8010749c,(%esp)
...
80104d41:	c7 44 24 04 b8 74 10 	movl   $0x801074b8,0x4(%esp)
80104d48:	80 
...
80104d59:	c7 44 24 04 b7 74 10 	movl   $0x801074b7,0x4(%esp)
80104d60:	80 
...
80104ea8:	e9 48 ff ff ff       	jmp    80104df5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104ead:	c7 04 24 dc 74 10 80 	movl   $0x801074dc,(%esp)
80104eb4:	e8 a7 b4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104eb9:	c7 04 24 ee 74 10 80 	movl   $0x801074ee,(%esp)
80104ec0:	e8 9b b4 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104ec5:	c7 04 24 ca 74 10 80 	movl   $0x801074ca,(%esp)
...
{
  return fork();
80105334:	e9 47 e5 ff ff       	jmp    80103880 <fork>
...
80105343:	83 ec 08             	sub    $0x8,%esp
  exit();
80105346:	e8 f5 e7 ff ff       	call   80103b40 <exit>
...
{
  return wait();
80105354:	e9 37 ea ff ff       	jmp    80103d90 <wait>
...
80105383:	e8 68 eb ff ff       	call   80103ef0 <kill>
}
80105388:	c9                   	leave  
80105389:	c3                   	ret    
...
801053a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801053a6:	e8 25 e3 ff ff       	call   801036d0 <myproc>
...
801053cc:	78 22                	js     801053f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801053ce:	e8 fd e2 ff ff       	call   801036d0 <myproc>
  if(growproc(n) < 0)
...
801053db:	e8 30 e4 ff ff       	call   80103810 <growproc>
...
8010541c:	78 7e                	js     8010549c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010541e:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
80105425:	e8 56 ee ff ff       	call   80104280 <acquire>
  ticks0 = ticks;
...
8010542a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010542d:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  while(ticks - ticks0 < n){
...
80105440:	c7 44 24 04 60 50 11 	movl   $0x80115060,0x4(%esp)
80105447:	80 
80105448:	c7 04 24 a0 58 11 80 	movl   $0x801158a0,(%esp)
8010544f:	e8 8c e8 ff ff       	call   80103ce0 <sleep>
...
80105484:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
80105488:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
...
801054b4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801054b7:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
801054be:	e8 bd ed ff ff       	call   80104280 <acquire>
  xticks = ticks;
801054c3:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  release(&tickslock);
801054c9:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
...
801054f4:	e8 b7 f1 ff ff       	call   801046b0 <argint>
	lotto(tickets);
801054f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054fc:	89 04 24             	mov    %eax,(%esp)
801054ff:	e8 3c eb ff ff       	call   80104040 <lotto>
	return 0;
}
...
80105589:	c7 44 24 04 fd 74 10 	movl   $0x801074fd,0x4(%esp)
80105590:	80 
...
801055b6:	66 a3 a6 52 11 80    	mov    %ax,0x801152a6
  ...
  initlock(&tickslock, "time");
801055bc:	e8 cf eb ff ff       	call   80104190 <initlock>
}
801055c1:	c9                   	leave  
801055c2:	c3                   	ret    
...
80105620:	ff 24 85 a4 75 10 80 	jmp    *-0x7fef8a5c(,%eax,4)
80105627:	90                   	nop
    lapiceoi();
    break;
...
80105628:	e8 a3 e0 ff ff       	call   801036d0 <myproc>
...
8010564c:	e8 5f e0 ff ff       	call   801036b0 <cpuid>
...
8010565c:	e8 6f e0 ff ff       	call   801036d0 <myproc>
80105661:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105664:	e8 67 e0 ff ff       	call   801036d0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
...
80105693:	c7 04 24 60 75 10 80 	movl   $0x80107560,(%esp)
...
8010569e:	e8 ad af ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
801056a3:	e8 28 e0 ff ff       	call   801036d0 <myproc>
...
801056b9:	e8 12 e0 ff ff       	call   801036d0 <myproc>
...
801056c5:	e8 06 e0 ff ff       	call   801036d0 <myproc>
...
801056e4:	e8 e7 df ff ff       	call   801036d0 <myproc>
...
8010571b:	75 a8                	jne    801056c5 <trap+0xc5>
    exit();
8010571d:	e8 1e e4 ff ff       	call   80103b40 <exit>
...
80105730:	75 a9                	jne    801056db <trap+0xdb>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
80105732:	e8 69 e5 ff ff       	call   80103ca0 <yield>
...
80105739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105740:	e8 6b df ff ff       	call   801036b0 <cpuid>
...
80105787:	e8 24 df ff ff       	call   801036b0 <cpuid>
8010578c:	c7 04 24 08 75 10 80 	movl   $0x80107508,(%esp)
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
801057c0:	e8 0b df ff ff       	call   801036d0 <myproc>
801057c5:	8b 70 24             	mov    0x24(%eax),%esi
801057c8:	85 f6                	test   %esi,%esi
801057ca:	75 2c                	jne    801057f8 <trap+0x1f8>
      exit();
    myproc()->tf = tf;
801057cc:	e8 ff de ff ff       	call   801036d0 <myproc>
801057d1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801057d4:	e8 a7 ef ff ff       	call   80104780 <syscall>
    if(myproc()->killed)
...
801057ef:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801057f0:	e9 4b e3 ff ff       	jmp    80103b40 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801057f8:	e8 43 e3 ff ff       	call   80103b40 <exit>
...
80105807:	e8 74 ea ff ff       	call   80104280 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105826:	e8 45 eb ff ff       	call   80104370 <release>
...
80105836:	e8 75 de ff ff       	call   801036b0 <cpuid>
...
8010584a:	c7 04 24 2c 75 10 80 	movl   $0x8010752c,(%esp)
80105851:	89 44 24 04          	mov    %eax,0x4(%esp)
80105855:	e8 f6 ad ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010585a:	c7 04 24 02 75 10 80 	movl   $0x80107502,(%esp)
...
80105957:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105958:	bb 24 76 10 80       	mov    $0x80107624,%ebx
...
801059a6:	6a 00                	push   $0x0
  jmp alltraps
801059a8:	e9 5b fb ff ff       	jmp    80105508 <alltraps>
...
801059af:	6a 01                	push   $0x1
  jmp alltraps
801059b1:	e9 52 fb ff ff       	jmp    80105508 <alltraps>
...
801059b8:	6a 02                	push   $0x2
  jmp alltraps
801059ba:	e9 49 fb ff ff       	jmp    80105508 <alltraps>
...
801059c1:	6a 03                	push   $0x3
  jmp alltraps
801059c3:	e9 40 fb ff ff       	jmp    80105508 <alltraps>
...
801059ca:	6a 04                	push   $0x4
  jmp alltraps
801059cc:	e9 37 fb ff ff       	jmp    80105508 <alltraps>
...
801059d3:	6a 05                	push   $0x5
  jmp alltraps
801059d5:	e9 2e fb ff ff       	jmp    80105508 <alltraps>
...
801059dc:	6a 06                	push   $0x6
  jmp alltraps
801059de:	e9 25 fb ff ff       	jmp    80105508 <alltraps>
...
801059e5:	6a 07                	push   $0x7
  jmp alltraps
801059e7:	e9 1c fb ff ff       	jmp    80105508 <alltraps>
...
801059ec:	6a 08                	push   $0x8
  jmp alltraps
801059ee:	e9 15 fb ff ff       	jmp    80105508 <alltraps>
...
801059f5:	6a 09                	push   $0x9
  jmp alltraps
801059f7:	e9 0c fb ff ff       	jmp    80105508 <alltraps>
...
801059fc:	6a 0a                	push   $0xa
  jmp alltraps
801059fe:	e9 05 fb ff ff       	jmp    80105508 <alltraps>
...
80105a03:	6a 0b                	push   $0xb
  jmp alltraps
80105a05:	e9 fe fa ff ff       	jmp    80105508 <alltraps>
...
80105a0a:	6a 0c                	push   $0xc
  jmp alltraps
80105a0c:	e9 f7 fa ff ff       	jmp    80105508 <alltraps>
...
80105a11:	6a 0d                	push   $0xd
  jmp alltraps
80105a13:	e9 f0 fa ff ff       	jmp    80105508 <alltraps>
...
80105a18:	6a 0e                	push   $0xe
  jmp alltraps
80105a1a:	e9 e9 fa ff ff       	jmp    80105508 <alltraps>
...
80105a21:	6a 0f                	push   $0xf
  jmp alltraps
80105a23:	e9 e0 fa ff ff       	jmp    80105508 <alltraps>
...
80105a2a:	6a 10                	push   $0x10
  jmp alltraps
80105a2c:	e9 d7 fa ff ff       	jmp    80105508 <alltraps>
...
80105a31:	6a 11                	push   $0x11
  jmp alltraps
80105a33:	e9 d0 fa ff ff       	jmp    80105508 <alltraps>
...
80105a3a:	6a 12                	push   $0x12
  jmp alltraps
80105a3c:	e9 c7 fa ff ff       	jmp    80105508 <alltraps>
...
80105a43:	6a 13                	push   $0x13
  jmp alltraps
80105a45:	e9 be fa ff ff       	jmp    80105508 <alltraps>
...
80105a4c:	6a 14                	push   $0x14
  jmp alltraps
80105a4e:	e9 b5 fa ff ff       	jmp    80105508 <alltraps>
...
80105a55:	6a 15                	push   $0x15
  jmp alltraps
80105a57:	e9 ac fa ff ff       	jmp    80105508 <alltraps>
...
80105a5e:	6a 16                	push   $0x16
  jmp alltraps
80105a60:	e9 a3 fa ff ff       	jmp    80105508 <alltraps>
...
80105a67:	6a 17                	push   $0x17
  jmp alltraps
80105a69:	e9 9a fa ff ff       	jmp    80105508 <alltraps>
...
80105a70:	6a 18                	push   $0x18
  jmp alltraps
80105a72:	e9 91 fa ff ff       	jmp    80105508 <alltraps>
...
80105a79:	6a 19                	push   $0x19
  jmp alltraps
80105a7b:	e9 88 fa ff ff       	jmp    80105508 <alltraps>
...
80105a82:	6a 1a                	push   $0x1a
  jmp alltraps
80105a84:	e9 7f fa ff ff       	jmp    80105508 <alltraps>
...
80105a8b:	6a 1b                	push   $0x1b
  jmp alltraps
80105a8d:	e9 76 fa ff ff       	jmp    80105508 <alltraps>
...
80105a94:	6a 1c                	push   $0x1c
  jmp alltraps
80105a96:	e9 6d fa ff ff       	jmp    80105508 <alltraps>
...
80105a9d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a9f:	e9 64 fa ff ff       	jmp    80105508 <alltraps>
...
80105aa6:	6a 1e                	push   $0x1e
  jmp alltraps
80105aa8:	e9 5b fa ff ff       	jmp    80105508 <alltraps>
...
80105aaf:	6a 1f                	push   $0x1f
  jmp alltraps
80105ab1:	e9 52 fa ff ff       	jmp    80105508 <alltraps>
...
80105ab8:	6a 20                	push   $0x20
  jmp alltraps
80105aba:	e9 49 fa ff ff       	jmp    80105508 <alltraps>
...
80105ac1:	6a 21                	push   $0x21
  jmp alltraps
80105ac3:	e9 40 fa ff ff       	jmp    80105508 <alltraps>
...
80105aca:	6a 22                	push   $0x22
  jmp alltraps
80105acc:	e9 37 fa ff ff       	jmp    80105508 <alltraps>
...
80105ad3:	6a 23                	push   $0x23
  jmp alltraps
80105ad5:	e9 2e fa ff ff       	jmp    80105508 <alltraps>
...
80105adc:	6a 24                	push   $0x24
  jmp alltraps
80105ade:	e9 25 fa ff ff       	jmp    80105508 <alltraps>
...
80105ae5:	6a 25                	push   $0x25
  jmp alltraps
80105ae7:	e9 1c fa ff ff       	jmp    80105508 <alltraps>
...
80105aee:	6a 26                	push   $0x26
  jmp alltraps
80105af0:	e9 13 fa ff ff       	jmp    80105508 <alltraps>
...
80105af7:	6a 27                	push   $0x27
  jmp alltraps
80105af9:	e9 0a fa ff ff       	jmp    80105508 <alltraps>
...
80105b00:	6a 28                	push   $0x28
  jmp alltraps
80105b02:	e9 01 fa ff ff       	jmp    80105508 <alltraps>
...
80105b09:	6a 29                	push   $0x29
  jmp alltraps
80105b0b:	e9 f8 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b12:	6a 2a                	push   $0x2a
  jmp alltraps
80105b14:	e9 ef f9 ff ff       	jmp    80105508 <alltraps>
...
80105b1b:	6a 2b                	push   $0x2b
  jmp alltraps
80105b1d:	e9 e6 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b24:	6a 2c                	push   $0x2c
  jmp alltraps
80105b26:	e9 dd f9 ff ff       	jmp    80105508 <alltraps>
...
80105b2d:	6a 2d                	push   $0x2d
  jmp alltraps
80105b2f:	e9 d4 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b36:	6a 2e                	push   $0x2e
  jmp alltraps
80105b38:	e9 cb f9 ff ff       	jmp    80105508 <alltraps>
...
80105b3f:	6a 2f                	push   $0x2f
  jmp alltraps
80105b41:	e9 c2 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b48:	6a 30                	push   $0x30
  jmp alltraps
80105b4a:	e9 b9 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b51:	6a 31                	push   $0x31
  jmp alltraps
80105b53:	e9 b0 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b5a:	6a 32                	push   $0x32
  jmp alltraps
80105b5c:	e9 a7 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b63:	6a 33                	push   $0x33
  jmp alltraps
80105b65:	e9 9e f9 ff ff       	jmp    80105508 <alltraps>
...
80105b6c:	6a 34                	push   $0x34
  jmp alltraps
80105b6e:	e9 95 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b75:	6a 35                	push   $0x35
  jmp alltraps
80105b77:	e9 8c f9 ff ff       	jmp    80105508 <alltraps>
...
80105b7e:	6a 36                	push   $0x36
  jmp alltraps
80105b80:	e9 83 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b87:	6a 37                	push   $0x37
  jmp alltraps
80105b89:	e9 7a f9 ff ff       	jmp    80105508 <alltraps>
...
80105b90:	6a 38                	push   $0x38
  jmp alltraps
80105b92:	e9 71 f9 ff ff       	jmp    80105508 <alltraps>
...
80105b99:	6a 39                	push   $0x39
  jmp alltraps
80105b9b:	e9 68 f9 ff ff       	jmp    80105508 <alltraps>
...
80105ba2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ba4:	e9 5f f9 ff ff       	jmp    80105508 <alltraps>
...
80105bab:	6a 3b                	push   $0x3b
  jmp alltraps
80105bad:	e9 56 f9 ff ff       	jmp    80105508 <alltraps>
...
80105bb4:	6a 3c                	push   $0x3c
  jmp alltraps
80105bb6:	e9 4d f9 ff ff       	jmp    80105508 <alltraps>
...
80105bbd:	6a 3d                	push   $0x3d
  jmp alltraps
80105bbf:	e9 44 f9 ff ff       	jmp    80105508 <alltraps>
...
80105bc6:	6a 3e                	push   $0x3e
  jmp alltraps
80105bc8:	e9 3b f9 ff ff       	jmp    80105508 <alltraps>
...
80105bcf:	6a 3f                	push   $0x3f
  jmp alltraps
80105bd1:	e9 32 f9 ff ff       	jmp    80105508 <alltraps>
...
80105bd8:	6a 40                	push   $0x40
  jmp alltraps
80105bda:	e9 29 f9 ff ff       	jmp    80105508 <alltraps>
...
80105be1:	6a 41                	push   $0x41
  jmp alltraps
80105be3:	e9 20 f9 ff ff       	jmp    80105508 <alltraps>
...
80105bea:	6a 42                	push   $0x42
  jmp alltraps
80105bec:	e9 17 f9 ff ff       	jmp    80105508 <alltraps>
...
80105bf3:	6a 43                	push   $0x43
  jmp alltraps
80105bf5:	e9 0e f9 ff ff       	jmp    80105508 <alltraps>
...
80105bfc:	6a 44                	push   $0x44
  jmp alltraps
80105bfe:	e9 05 f9 ff ff       	jmp    80105508 <alltraps>
...
80105c05:	6a 45                	push   $0x45
  jmp alltraps
80105c07:	e9 fc f8 ff ff       	jmp    80105508 <alltraps>
...
80105c0e:	6a 46                	push   $0x46
  jmp alltraps
80105c10:	e9 f3 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c17:	6a 47                	push   $0x47
  jmp alltraps
80105c19:	e9 ea f8 ff ff       	jmp    80105508 <alltraps>
...
80105c20:	6a 48                	push   $0x48
  jmp alltraps
80105c22:	e9 e1 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c29:	6a 49                	push   $0x49
  jmp alltraps
80105c2b:	e9 d8 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c32:	6a 4a                	push   $0x4a
  jmp alltraps
80105c34:	e9 cf f8 ff ff       	jmp    80105508 <alltraps>
...
80105c3b:	6a 4b                	push   $0x4b
  jmp alltraps
80105c3d:	e9 c6 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c44:	6a 4c                	push   $0x4c
  jmp alltraps
80105c46:	e9 bd f8 ff ff       	jmp    80105508 <alltraps>
...
80105c4d:	6a 4d                	push   $0x4d
  jmp alltraps
80105c4f:	e9 b4 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c56:	6a 4e                	push   $0x4e
  jmp alltraps
80105c58:	e9 ab f8 ff ff       	jmp    80105508 <alltraps>
...
80105c5f:	6a 4f                	push   $0x4f
  jmp alltraps
80105c61:	e9 a2 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c68:	6a 50                	push   $0x50
  jmp alltraps
80105c6a:	e9 99 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c71:	6a 51                	push   $0x51
  jmp alltraps
80105c73:	e9 90 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c7a:	6a 52                	push   $0x52
  jmp alltraps
80105c7c:	e9 87 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c83:	6a 53                	push   $0x53
  jmp alltraps
80105c85:	e9 7e f8 ff ff       	jmp    80105508 <alltraps>
...
80105c8c:	6a 54                	push   $0x54
  jmp alltraps
80105c8e:	e9 75 f8 ff ff       	jmp    80105508 <alltraps>
...
80105c95:	6a 55                	push   $0x55
  jmp alltraps
80105c97:	e9 6c f8 ff ff       	jmp    80105508 <alltraps>
...
80105c9e:	6a 56                	push   $0x56
  jmp alltraps
80105ca0:	e9 63 f8 ff ff       	jmp    80105508 <alltraps>
...
80105ca7:	6a 57                	push   $0x57
  jmp alltraps
80105ca9:	e9 5a f8 ff ff       	jmp    80105508 <alltraps>
...
80105cb0:	6a 58                	push   $0x58
  jmp alltraps
80105cb2:	e9 51 f8 ff ff       	jmp    80105508 <alltraps>
...
80105cb9:	6a 59                	push   $0x59
  jmp alltraps
80105cbb:	e9 48 f8 ff ff       	jmp    80105508 <alltraps>
...
80105cc2:	6a 5a                	push   $0x5a
  jmp alltraps
80105cc4:	e9 3f f8 ff ff       	jmp    80105508 <alltraps>
...
80105ccb:	6a 5b                	push   $0x5b
  jmp alltraps
80105ccd:	e9 36 f8 ff ff       	jmp    80105508 <alltraps>
...
80105cd4:	6a 5c                	push   $0x5c
  jmp alltraps
80105cd6:	e9 2d f8 ff ff       	jmp    80105508 <alltraps>
...
80105cdd:	6a 5d                	push   $0x5d
  jmp alltraps
80105cdf:	e9 24 f8 ff ff       	jmp    80105508 <alltraps>
...
80105ce6:	6a 5e                	push   $0x5e
  jmp alltraps
80105ce8:	e9 1b f8 ff ff       	jmp    80105508 <alltraps>
...
80105cef:	6a 5f                	push   $0x5f
  jmp alltraps
80105cf1:	e9 12 f8 ff ff       	jmp    80105508 <alltraps>
...
80105cf8:	6a 60                	push   $0x60
  jmp alltraps
80105cfa:	e9 09 f8 ff ff       	jmp    80105508 <alltraps>
...
80105d01:	6a 61                	push   $0x61
  jmp alltraps
80105d03:	e9 00 f8 ff ff       	jmp    80105508 <alltraps>
...
80105d0a:	6a 62                	push   $0x62
  jmp alltraps
80105d0c:	e9 f7 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d13:	6a 63                	push   $0x63
  jmp alltraps
80105d15:	e9 ee f7 ff ff       	jmp    80105508 <alltraps>
...
80105d1c:	6a 64                	push   $0x64
  jmp alltraps
80105d1e:	e9 e5 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d25:	6a 65                	push   $0x65
  jmp alltraps
80105d27:	e9 dc f7 ff ff       	jmp    80105508 <alltraps>
...
80105d2e:	6a 66                	push   $0x66
  jmp alltraps
80105d30:	e9 d3 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d37:	6a 67                	push   $0x67
  jmp alltraps
80105d39:	e9 ca f7 ff ff       	jmp    80105508 <alltraps>
...
80105d40:	6a 68                	push   $0x68
  jmp alltraps
80105d42:	e9 c1 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d49:	6a 69                	push   $0x69
  jmp alltraps
80105d4b:	e9 b8 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d52:	6a 6a                	push   $0x6a
  jmp alltraps
80105d54:	e9 af f7 ff ff       	jmp    80105508 <alltraps>
...
80105d5b:	6a 6b                	push   $0x6b
  jmp alltraps
80105d5d:	e9 a6 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d64:	6a 6c                	push   $0x6c
  jmp alltraps
80105d66:	e9 9d f7 ff ff       	jmp    80105508 <alltraps>
...
80105d6d:	6a 6d                	push   $0x6d
  jmp alltraps
80105d6f:	e9 94 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d76:	6a 6e                	push   $0x6e
  jmp alltraps
80105d78:	e9 8b f7 ff ff       	jmp    80105508 <alltraps>
...
80105d7f:	6a 6f                	push   $0x6f
  jmp alltraps
80105d81:	e9 82 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d88:	6a 70                	push   $0x70
  jmp alltraps
80105d8a:	e9 79 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d91:	6a 71                	push   $0x71
  jmp alltraps
80105d93:	e9 70 f7 ff ff       	jmp    80105508 <alltraps>
...
80105d9a:	6a 72                	push   $0x72
  jmp alltraps
80105d9c:	e9 67 f7 ff ff       	jmp    80105508 <alltraps>
...
80105da3:	6a 73                	push   $0x73
  jmp alltraps
80105da5:	e9 5e f7 ff ff       	jmp    80105508 <alltraps>
...
80105dac:	6a 74                	push   $0x74
  jmp alltraps
80105dae:	e9 55 f7 ff ff       	jmp    80105508 <alltraps>
...
80105db5:	6a 75                	push   $0x75
  jmp alltraps
80105db7:	e9 4c f7 ff ff       	jmp    80105508 <alltraps>
...
80105dbe:	6a 76                	push   $0x76
  jmp alltraps
80105dc0:	e9 43 f7 ff ff       	jmp    80105508 <alltraps>
...
80105dc7:	6a 77                	push   $0x77
  jmp alltraps
80105dc9:	e9 3a f7 ff ff       	jmp    80105508 <alltraps>
...
80105dd0:	6a 78                	push   $0x78
  jmp alltraps
80105dd2:	e9 31 f7 ff ff       	jmp    80105508 <alltraps>
...
80105dd9:	6a 79                	push   $0x79
  jmp alltraps
80105ddb:	e9 28 f7 ff ff       	jmp    80105508 <alltraps>
...
80105de2:	6a 7a                	push   $0x7a
  jmp alltraps
80105de4:	e9 1f f7 ff ff       	jmp    80105508 <alltraps>
...
80105deb:	6a 7b                	push   $0x7b
  jmp alltraps
80105ded:	e9 16 f7 ff ff       	jmp    80105508 <alltraps>
...
80105df4:	6a 7c                	push   $0x7c
  jmp alltraps
80105df6:	e9 0d f7 ff ff       	jmp    80105508 <alltraps>
...
80105dfd:	6a 7d                	push   $0x7d
  jmp alltraps
80105dff:	e9 04 f7 ff ff       	jmp    80105508 <alltraps>
...
80105e06:	6a 7e                	push   $0x7e
  jmp alltraps
80105e08:	e9 fb f6 ff ff       	jmp    80105508 <alltraps>
...
80105e0f:	6a 7f                	push   $0x7f
  jmp alltraps
80105e11:	e9 f2 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e18:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105e1d:	e9 e6 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e24:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105e29:	e9 da f6 ff ff       	jmp    80105508 <alltraps>
...
80105e30:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105e35:	e9 ce f6 ff ff       	jmp    80105508 <alltraps>
...
80105e3c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105e41:	e9 c2 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e48:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105e4d:	e9 b6 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e54:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105e59:	e9 aa f6 ff ff       	jmp    80105508 <alltraps>
...
80105e60:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105e65:	e9 9e f6 ff ff       	jmp    80105508 <alltraps>
...
80105e6c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105e71:	e9 92 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e78:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105e7d:	e9 86 f6 ff ff       	jmp    80105508 <alltraps>
...
80105e84:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105e89:	e9 7a f6 ff ff       	jmp    80105508 <alltraps>
...
80105e90:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105e95:	e9 6e f6 ff ff       	jmp    80105508 <alltraps>
...
80105e9c:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105ea1:	e9 62 f6 ff ff       	jmp    80105508 <alltraps>
...
80105ea8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105ead:	e9 56 f6 ff ff       	jmp    80105508 <alltraps>
...
80105eb4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105eb9:	e9 4a f6 ff ff       	jmp    80105508 <alltraps>
...
80105ec0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105ec5:	e9 3e f6 ff ff       	jmp    80105508 <alltraps>
...
80105ecc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80105ed1:	e9 32 f6 ff ff       	jmp    80105508 <alltraps>
...
80105ed8:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105edd:	e9 26 f6 ff ff       	jmp    80105508 <alltraps>
...
80105ee4:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105ee9:	e9 1a f6 ff ff       	jmp    80105508 <alltraps>
...
80105ef0:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105ef5:	e9 0e f6 ff ff       	jmp    80105508 <alltraps>
...
80105efc:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80105f01:	e9 02 f6 ff ff       	jmp    80105508 <alltraps>
...
80105f08:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105f0d:	e9 f6 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f14:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105f19:	e9 ea f5 ff ff       	jmp    80105508 <alltraps>
...
80105f20:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105f25:	e9 de f5 ff ff       	jmp    80105508 <alltraps>
...
80105f2c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105f31:	e9 d2 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f38:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105f3d:	e9 c6 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f44:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105f49:	e9 ba f5 ff ff       	jmp    80105508 <alltraps>
...
80105f50:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80105f55:	e9 ae f5 ff ff       	jmp    80105508 <alltraps>
...
80105f5c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105f61:	e9 a2 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f68:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105f6d:	e9 96 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f74:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105f79:	e9 8a f5 ff ff       	jmp    80105508 <alltraps>
...
80105f80:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80105f85:	e9 7e f5 ff ff       	jmp    80105508 <alltraps>
...
80105f8c:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105f91:	e9 72 f5 ff ff       	jmp    80105508 <alltraps>
...
80105f98:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105f9d:	e9 66 f5 ff ff       	jmp    80105508 <alltraps>
...
80105fa4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105fa9:	e9 5a f5 ff ff       	jmp    80105508 <alltraps>
...
80105fb0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105fb5:	e9 4e f5 ff ff       	jmp    80105508 <alltraps>
...
80105fbc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80105fc1:	e9 42 f5 ff ff       	jmp    80105508 <alltraps>
...
80105fc8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105fcd:	e9 36 f5 ff ff       	jmp    80105508 <alltraps>
...
80105fd4:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105fd9:	e9 2a f5 ff ff       	jmp    80105508 <alltraps>
...
80105fe0:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105fe5:	e9 1e f5 ff ff       	jmp    80105508 <alltraps>
...
80105fec:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80105ff1:	e9 12 f5 ff ff       	jmp    80105508 <alltraps>
...
80105ff8:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105ffd:	e9 06 f5 ff ff       	jmp    80105508 <alltraps>
...
80106004:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106009:	e9 fa f4 ff ff       	jmp    80105508 <alltraps>
...
80106010:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106015:	e9 ee f4 ff ff       	jmp    80105508 <alltraps>
...
8010601c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106021:	e9 e2 f4 ff ff       	jmp    80105508 <alltraps>
...
80106028:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010602d:	e9 d6 f4 ff ff       	jmp    80105508 <alltraps>
...
80106034:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106039:	e9 ca f4 ff ff       	jmp    80105508 <alltraps>
...
80106040:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106045:	e9 be f4 ff ff       	jmp    80105508 <alltraps>
...
8010604c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106051:	e9 b2 f4 ff ff       	jmp    80105508 <alltraps>
...
80106058:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010605d:	e9 a6 f4 ff ff       	jmp    80105508 <alltraps>
...
80106064:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106069:	e9 9a f4 ff ff       	jmp    80105508 <alltraps>
...
80106070:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106075:	e9 8e f4 ff ff       	jmp    80105508 <alltraps>
...
8010607c:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106081:	e9 82 f4 ff ff       	jmp    80105508 <alltraps>
...
80106088:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010608d:	e9 76 f4 ff ff       	jmp    80105508 <alltraps>
...
80106094:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106099:	e9 6a f4 ff ff       	jmp    80105508 <alltraps>
...
801060a0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801060a5:	e9 5e f4 ff ff       	jmp    80105508 <alltraps>
...
801060ac:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801060b1:	e9 52 f4 ff ff       	jmp    80105508 <alltraps>
...
801060b8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801060bd:	e9 46 f4 ff ff       	jmp    80105508 <alltraps>
...
801060c4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801060c9:	e9 3a f4 ff ff       	jmp    80105508 <alltraps>
...
801060d0:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801060d5:	e9 2e f4 ff ff       	jmp    80105508 <alltraps>
...
801060dc:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801060e1:	e9 22 f4 ff ff       	jmp    80105508 <alltraps>
...
801060e8:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801060ed:	e9 16 f4 ff ff       	jmp    80105508 <alltraps>
...
801060f4:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801060f9:	e9 0a f4 ff ff       	jmp    80105508 <alltraps>
...
80106100:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106105:	e9 fe f3 ff ff       	jmp    80105508 <alltraps>
...
8010610c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106111:	e9 f2 f3 ff ff       	jmp    80105508 <alltraps>
...
80106118:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010611d:	e9 e6 f3 ff ff       	jmp    80105508 <alltraps>
...
80106124:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106129:	e9 da f3 ff ff       	jmp    80105508 <alltraps>
...
80106130:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106135:	e9 ce f3 ff ff       	jmp    80105508 <alltraps>
...
8010613c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106141:	e9 c2 f3 ff ff       	jmp    80105508 <alltraps>
...
80106148:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010614d:	e9 b6 f3 ff ff       	jmp    80105508 <alltraps>
...
80106154:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106159:	e9 aa f3 ff ff       	jmp    80105508 <alltraps>
...
80106160:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106165:	e9 9e f3 ff ff       	jmp    80105508 <alltraps>
...
8010616c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106171:	e9 92 f3 ff ff       	jmp    80105508 <alltraps>
...
80106178:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010617d:	e9 86 f3 ff ff       	jmp    80105508 <alltraps>
...
80106184:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106189:	e9 7a f3 ff ff       	jmp    80105508 <alltraps>
...
80106190:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106195:	e9 6e f3 ff ff       	jmp    80105508 <alltraps>
...
8010619c:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801061a1:	e9 62 f3 ff ff       	jmp    80105508 <alltraps>
...
801061a8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801061ad:	e9 56 f3 ff ff       	jmp    80105508 <alltraps>
...
801061b4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801061b9:	e9 4a f3 ff ff       	jmp    80105508 <alltraps>
...
801061c0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801061c5:	e9 3e f3 ff ff       	jmp    80105508 <alltraps>
...
801061cc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801061d1:	e9 32 f3 ff ff       	jmp    80105508 <alltraps>
...
801061d8:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801061dd:	e9 26 f3 ff ff       	jmp    80105508 <alltraps>
...
801061e4:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801061e9:	e9 1a f3 ff ff       	jmp    80105508 <alltraps>
...
801061f0:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801061f5:	e9 0e f3 ff ff       	jmp    80105508 <alltraps>
...
801061fc:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106201:	e9 02 f3 ff ff       	jmp    80105508 <alltraps>
...
80106208:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010620d:	e9 f6 f2 ff ff       	jmp    80105508 <alltraps>
...
80106214:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106219:	e9 ea f2 ff ff       	jmp    80105508 <alltraps>
...
80106220:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106225:	e9 de f2 ff ff       	jmp    80105508 <alltraps>
...
8010622c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106231:	e9 d2 f2 ff ff       	jmp    80105508 <alltraps>
...
80106238:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010623d:	e9 c6 f2 ff ff       	jmp    80105508 <alltraps>
...
80106244:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106249:	e9 ba f2 ff ff       	jmp    80105508 <alltraps>
...
80106250:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106255:	e9 ae f2 ff ff       	jmp    80105508 <alltraps>
...
8010625c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106261:	e9 a2 f2 ff ff       	jmp    80105508 <alltraps>
...
80106268:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010626d:	e9 96 f2 ff ff       	jmp    80105508 <alltraps>
...
80106274:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106279:	e9 8a f2 ff ff       	jmp    80105508 <alltraps>
...
80106280:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106285:	e9 7e f2 ff ff       	jmp    80105508 <alltraps>
...
8010628c:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106291:	e9 72 f2 ff ff       	jmp    80105508 <alltraps>
...
80106298:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010629d:	e9 66 f2 ff ff       	jmp    80105508 <alltraps>
...
801062a4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801062a9:	e9 5a f2 ff ff       	jmp    80105508 <alltraps>
...
801062b0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801062b5:	e9 4e f2 ff ff       	jmp    80105508 <alltraps>
...
801062bc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801062c1:	e9 42 f2 ff ff       	jmp    80105508 <alltraps>
...
801062c8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801062cd:	e9 36 f2 ff ff       	jmp    80105508 <alltraps>
...
801062d4:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801062d9:	e9 2a f2 ff ff       	jmp    80105508 <alltraps>
...
801062e0:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801062e5:	e9 1e f2 ff ff       	jmp    80105508 <alltraps>
...
801062ec:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801062f1:	e9 12 f2 ff ff       	jmp    80105508 <alltraps>
...
801062f8:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801062fd:	e9 06 f2 ff ff       	jmp    80105508 <alltraps>
...
80106304:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106309:	e9 fa f1 ff ff       	jmp    80105508 <alltraps>
...
80106310:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106315:	e9 ee f1 ff ff       	jmp    80105508 <alltraps>
...
8010631c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106321:	e9 e2 f1 ff ff       	jmp    80105508 <alltraps>
...
80106328:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010632d:	e9 d6 f1 ff ff       	jmp    80105508 <alltraps>
...
80106334:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106339:	e9 ca f1 ff ff       	jmp    80105508 <alltraps>
...
80106340:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106345:	e9 be f1 ff ff       	jmp    80105508 <alltraps>
...
8010634c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106351:	e9 b2 f1 ff ff       	jmp    80105508 <alltraps>
...
80106358:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010635d:	e9 a6 f1 ff ff       	jmp    80105508 <alltraps>
...
80106364:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106369:	e9 9a f1 ff ff       	jmp    80105508 <alltraps>
...
80106370:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106375:	e9 8e f1 ff ff       	jmp    80105508 <alltraps>
...
8010637c:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106381:	e9 82 f1 ff ff       	jmp    80105508 <alltraps>
...
80106388:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010638d:	e9 76 f1 ff ff       	jmp    80105508 <alltraps>
...
80106394:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106399:	e9 6a f1 ff ff       	jmp    80105508 <alltraps>
...
801063a0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801063a5:	e9 5e f1 ff ff       	jmp    80105508 <alltraps>
...
801063ac:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801063b1:	e9 52 f1 ff ff       	jmp    80105508 <alltraps>
...
801063b8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801063bd:	e9 46 f1 ff ff       	jmp    80105508 <alltraps>
...
801063c4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801063c9:	e9 3a f1 ff ff       	jmp    80105508 <alltraps>
...
801063d0:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801063d5:	e9 2e f1 ff ff       	jmp    80105508 <alltraps>
...
801063dc:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801063e1:	e9 22 f1 ff ff       	jmp    80105508 <alltraps>
...
801063e8:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801063ed:	e9 16 f1 ff ff       	jmp    80105508 <alltraps>
...
801063f4:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801063f9:	e9 0a f1 ff ff       	jmp    80105508 <alltraps>
...
80106400:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106405:	e9 fe f0 ff ff       	jmp    80105508 <alltraps>
...
8010640c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106411:	e9 f2 f0 ff ff       	jmp    80105508 <alltraps>
...
80106482:	e8 39 df ff ff       	call   801043c0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106521:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106522:	c7 04 24 2c 76 10 80 	movl   $0x8010762c,(%esp)
...
801065d3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801065d6:	e8 d5 d0 ff ff       	call   801036b0 <cpuid>
...
801066d4:	0f 84 c3 00 00 00    	je     8010679d <switchuvm+0xed>
  ...
  pushcli();
801066da:	e8 61 db ff ff       	call   80104240 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801066df:	e8 4c cf ff ff       	call   80103630 <mycpu>
801066e4:	89 c3                	mov    %eax,%ebx
801066e6:	e8 45 cf ff ff       	call   80103630 <mycpu>
801066eb:	89 c7                	mov    %eax,%edi
801066ed:	e8 3e cf ff ff       	call   80103630 <mycpu>
801066f2:	83 c7 08             	add    $0x8,%edi
801066f5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801066f8:	e8 33 cf ff ff       	call   80103630 <mycpu>
...
80106739:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010673e:	e8 ed ce ff ff       	call   80103630 <mycpu>
80106743:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010674a:	e8 e1 ce ff ff       	call   80103630 <mycpu>
8010674f:	b9 10 00 00 00       	mov    $0x10,%ecx
80106754:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106758:	e8 d3 ce ff ff       	call   80103630 <mycpu>
...
80106766:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106769:	e8 c2 ce ff ff       	call   80103630 <mycpu>
...
8010678b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010678c:	e9 6f db ff ff       	jmp    80104300 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106791:	c7 04 24 32 76 10 80 	movl   $0x80107632,(%esp)
80106798:	e8 c3 9b ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010679d:	c7 04 24 5d 76 10 80 	movl   $0x8010765d,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
801067a9:	c7 04 24 48 76 10 80 	movl   $0x80107648,(%esp)
...
801067f7:	e8 c4 db ff ff       	call   801043c0 <memset>
...
8010682b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
8010682c:	e9 2f dc ff ff       	jmp    80104460 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106831:	c7 04 24 71 76 10 80 	movl   $0x80107671,(%esp)
...
801068e1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801068e2:	c7 04 24 8b 76 10 80 	movl   $0x8010768b,(%esp)
801068e9:	e8 72 9a ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801068ee:	c7 04 24 2c 77 10 80 	movl   $0x8010772c,(%esp)
...
80106943:	e8 78 da ff ff       	call   801043c0 <memset>
...
8010697f:	75 af                	jne    80106930 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106981:	c7 04 24 a9 76 10 80 	movl   $0x801076a9,(%esp)
...
801069aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
801069b0:	c7 04 24 c1 76 10 80 	movl   $0x801076c1,(%esp)
...
freevm(pde_t *pgdir)
{
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106a78:	c7 04 24 dd 76 10 80 	movl   $0x801076dd,(%esp)
...
80106abb:	e8 00 d9 ff ff       	call   801043c0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106b5b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106b5c:	c7 04 24 ee 76 10 80 	movl   $0x801076ee,(%esp)
...
80106b83:	0f 84 b2 00 00 00    	je     80106c3b <copyuvm+0xcb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b89:	8b 45 0c             	mov    0xc(%ebp),%eax
80106b8c:	85 c0                	test   %eax,%eax
80106b8e:	0f 84 9c 00 00 00    	je     80106c30 <copyuvm+0xc0>
...
80106bd3:	78 41                	js     80106c16 <copyuvm+0xa6>
  uint pa, i, flags;
  char *mem;
...
80106bdb:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106bde:	76 50                	jbe    80106c30 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106be0:	8b 45 08             	mov    0x8(%ebp),%eax
80106be3:	31 c9                	xor    %ecx,%ecx
80106be5:	89 da                	mov    %ebx,%edx
80106be7:	e8 34 f8 ff ff       	call   80106420 <walkpgdir>
80106bec:	85 c0                	test   %eax,%eax
80106bee:	74 5b                	je     80106c4b <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106bf0:	8b 30                	mov    (%eax),%esi
80106bf2:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bf8:	74 45                	je     80106c3f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106bfa:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106bfc:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c02:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c05:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c0b:	e8 a0 b8 ff ff       	call   801024b0 <kalloc>
80106c10:	85 c0                	test   %eax,%eax
80106c12:	89 c6                	mov    %eax,%esi
80106c14:	75 82                	jne    80106b98 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106c16:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106c19:	89 04 24             	mov    %eax,(%esp)
80106c1c:	e8 ef fd ff ff       	call   80106a10 <freevm>
  return 0;
80106c21:	31 c0                	xor    %eax,%eax
}
80106c23:	83 c4 2c             	add    $0x2c,%esp
80106c26:	5b                   	pop    %ebx
80106c27:	5e                   	pop    %esi
80106c28:	5f                   	pop    %edi
80106c29:	5d                   	pop    %ebp
...
80106c3d:	eb e4                	jmp    80106c23 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106c3f:	c7 04 24 12 77 10 80 	movl   $0x80107712,(%esp)
80106c46:	e8 15 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106c4b:	c7 04 24 f8 76 10 80 	movl   $0x801076f8,(%esp)
80106c52:	e8 09 97 ff ff       	call   80100360 <panic>
...
80106cdc:	e8 7f d7 ff ff       	call   80104460 <memmove>
    len -= n;
    buf += n;
